...
var budgetController = (function () {
	...
	Expense.prototype.calculatePercentage =
	...
	Expense.prototype.getPercentage = function () {
		return this
			.percentage; /**This is the percentage for each expense */
	};
	...
	var data = {
		...
		budget: 0,
		percentage:
			-1 /**This percentage is the overall expenses percentage */,
	};
...
var UIController = (function () {
	...
	return {
		...
		clearFields: function () {
			...
			fieldsArr =
				Array.prototype.slice.call(fields); //converting fields which is a nodeList to an array
		...
		changedType: function () {
			...
			//We are calling the nodeList here
...
var controller = (function (budgetCtrl, UICtrl) {
	...
	var updatePercentages = function () {
		...
		var percentages =
			budgetCtrl.getPercentages(); /**This percentages variable is an array of all percentages */
	...
	var ctrlAddItem = function () {
		...
		if (
			...
			//This newItem returned would contain ID, description, value
